...
function () {
  function Preview() {
    ...
    this._setInitialStory = function _callee(initialSelection) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return regeneratorRuntime.awrap(_this._getInitialStory(initialSelection, shouldPersistSelection)());
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 5:
                ...
                _context2.t0 = JSON;
                _context2.next = 12;
                return regeneratorRuntime.awrap(_reactNative.AsyncStorage.getItem(STORAGE_KEY));
  ...
  _createClass(Preview, [{
    ...
    value: function _selectStoryEvent(_ref) {
      ...
      if (storyId) {
        ...
        var _story = this._getStory(storyId);

        this._selectStory(_story);
      }
    }
  }, {
    key: "_selectStory",
