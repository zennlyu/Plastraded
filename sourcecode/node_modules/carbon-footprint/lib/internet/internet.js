...
*/
const getInternetUsageCarbonImpact = (duration, dataWeight, carbonElectricityIntensity) => {
    /* GHG : greenhouse gas */
    const GHGdataCenter = dataWeight * FactorDataCenter * __1.electricity.world;
    const GHGnetwork = dataWeight * FactorNetwork * __1.electricity.world;
    const GHGdevice = duration * FactorDevice * __1.electricity[carbonElectricityIntensity];
    /* kgCO₂eq */
    return GHGdataCenter + GHGnetwork + GHGdevice;
};
exports.getInternetUsageCarbonImpact = getInternetUsageCarbonImpact;
